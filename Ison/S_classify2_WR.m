function [all_output,av_predictedOutput, success_rate, av_confidence_all,std_confidence_all, av_max_conf, std_max_conf, error, error2, confidence_matrix] = S_classify2_WR(predictedOutput, trueOutput, nsteps,tw, proc, nOutputUnits)
