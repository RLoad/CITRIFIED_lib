...
disp('-----------------------------------------------------------')
disp('          Classification with RBF SVM - one model')
disp('-----------------------------------------------------------')
...
save(['data/ableBodied' num2str(sbjID) '/results/' num2str(nbmuscles) 'muscles' num2str(nbClasses) 'classes_RBF_SVM_OneClassifier_02042017.mat'],'oneESNSs','oneESNRpG','testingSet','crossValidationFolders1','crossValidationFolders2','crossValidationFolders2',...
    'bestModels','SVM_performances','SVM_performances_std',...
    'bestPerf','best_C','C_param','best_gama')
