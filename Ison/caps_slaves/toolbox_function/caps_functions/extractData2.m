function MAToutput = extractData2(subjectpath)
...
start_dir='C:\CAPS\DEV\USERS'; %Code user can modify starting directory to more quickly find  desired User folder
