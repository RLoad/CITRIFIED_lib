function [scores,results_per_grasp]=LDATest3(Models,dataSet,historyTW,SR,velocityThreshold,maxValues,nb_classes)
...
%                 timeWindowOutputTest=svmpredict(1,dataSet{trl}.emg{TWcounter}./maxValues{1},  Models{1}, ' -q');
                ...
                [timeWindowOutputTest,scoreLDA,costLDA]=predict( Models{1},dataSet{trl}.emg{TWcounter}./maxValues{1});
...
%                 timeWindowOutputTest=svmpredict(1,dataSet{trl}.emg{TWcounter}./maxValues{2},  Models{2}, ' -q');
                ...
                [timeWindowOutputTest,scoreLDA,costLDA]=predict( Models{2},dataSet{trl}.emg{TWcounter}./maxValues{2});
            ...
            [timeWindowOutputTest,scoreLDA,costLDA]=predict( Models{3},dataSet{trl}.emg{TWcounter}./maxValues{3});
