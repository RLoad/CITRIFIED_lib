function [scores,results_per_grasp]=ESNTest(bestPer,dataSet,labelsSet,div,historyTW)
...
for i=1:div
    ...
    for j=1:length(testOutputSequence)
        ...
        predictedTestOutput{j} = test_esn(testInputSequence{j},  bestPer{i}.performance.model, nForgetPoints) ; 
